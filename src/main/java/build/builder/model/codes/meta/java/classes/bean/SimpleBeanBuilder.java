...
public class SimpleBeanBuilder extends BeanBuilder{
    ...
    protected Map<String, MethodMeta> getAttributeMethods(Map<String, FieldMeta> fields, Set<Class<?>> importClasses) {
        ...
        fields.forEach((key,value)->{
            ...
            String getMethodTemplate="%sreturn %s;";
            String methodContent = String.format(getMethodTemplate, structureInternalIndentation(), key);
            ...
            String setMethodTemplate="%sthis.%s=%s;";
            String setMethodContent = String.format(setMethodTemplate, structureInternalIndentation(), key, key);
