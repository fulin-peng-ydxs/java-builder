...
public class TemplateUtils {
    ...
    */
            ...
            if(lines==null){
                ...
                try(InputStream in =stream){
                    lines = StringUtils.fileToLines(new InputStreamReader(
                            Objects.requireNonNull(in)), false, false, "\n");
    ...
    public static void paddingCreateInfo(Map<String,String> paddingValues){
        paddingValues.put("{date}", BuildGlobalConfig.templateInfo
                .getDateToFormat());
        paddingValues.put("{author}",BuildGlobalConfig.templateInfo.getUserName());
    }
}